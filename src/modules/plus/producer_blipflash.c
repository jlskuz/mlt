                              ...
                              int *samples)
{
    ...
    int frames = mlt_frame_get_position(frame)
                 + mlt_properties_get_int(producer_properties, "offset");
    ...
    *samples = *samples <= 0 ? mlt_audio_calculate_frame_samples(fps, *frequency, frames)
                             : *samples;
...
static void fill_image(mlt_properties producer_properties,
                       char *color,
                       uint8_t *buffer,
                              ...
                              int writable)
{
    ...
    *buffer = mlt_pool_alloc(size);
    ...
    mlt_properties_set_double(properties,
                              "aspect_ratio",
                              mlt_properties_get_double(producer_properties, "aspect_ratio"));
...
mlt_producer producer_blipflash_init(mlt_profile profile,
